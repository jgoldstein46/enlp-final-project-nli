...
class EISM(NLI_Classifier_Base):
    def __init__(self, params):
        ...
        # our encoder
        self.encoder = Bidirectional(LSTM(self.hidden_size, return_sequences=True, dropout=self.dropout))
        self.attention_layer = Attention(dropout=self.dropout)
        self.composition_layer = Bidirectional(LSTM(self.hidden_size, return_sequences=True, dropout=self.dropout))
